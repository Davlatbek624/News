...
export default function Home() {
    ...
    useEffect(() => {
        fetch("https://newsapi.org/v2/everything?q=apple&from=2026-01-23&sortBy=popularity&apiKey=ca5341aad4da4a4d8947d21b0c750a09")
            .then(res => res.json())
            .then(obj => setData(obj.articles || []))
        ...
        <div className="min-h-screen bg-white flex flex-col items-center p-6">
            <div className="w-full max-w-7xl">
                <input
                    ...
                    className="w-full p-3 border-b-2 border-gray-200 mb-8 outline-none focus:border-[#109BE9] text-xl font-light"
                />
